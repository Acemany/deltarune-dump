...
<meta property="article:published_time" content="2025-05-30T03:55:18+00:00">
<meta name="twitter:card" content="summary">
<meta name="twitter:site" content="@undertale">

<link rel="stylesheet" href="/_bridgetown/static/index.F7DIB7L4.css" />

<link rel="stylesheet" href="/assets/css/en_US.css" />
<script src="/_bridgetown/static/index.VGQXVU7I.js" defer></script>
  ...
  <div class="relative w-full">
    ...
    <main>
      <div class="flex flex-col gap-16 py-16 overflow-visible" data-controller="scroll">
  <section id="home" class="relative container mx-auto max-w-2xl px-4">
    <img src="/assets/images/spire-fade.png" alt="Spire" class="absolute bg-black text-transparent w-24 md:w-32 rotate-180 -top-92 right-4 md:-right-16 -z-10 pointer-events-none motion-safe:animate-fade-in-top motion-safe:translate-y-0" aria-hidden="true" />
    <div class="absolute bg-black w-24 md:w-32 top-0 left-4 md:-left-16 -z-10 pointer-events-none motion-safe:animate-fade-in-top motion-safe:translate-y-0">
      <img src="/assets/images/spire-fade.png" alt="Spire" class="bg-black text-transparent w-24 md:w-32" aria-hidden="true" />
    </div>
    <h1><img src="/assets/images/logo.png" alt="DELTARUNE" class="w-lg mx-auto" /></h1>
    <h2 class="text-white text-3xl md:text-5xl font-8bit text-center mt-4 mb-16 tracking-tighter">Chapters 1-4</h2>
    <div data-controller="countdown" data-countdown-source-value="/is-it-ready-yet.txt">
      <h3 class="highlight-yellow text-xl md:text-3xl font-pixel text-center mb-4 min-h-10 motion-safe:animate-fade-in" data-countdown-target="date"></h3>
      <h3 class="text-deltarune-gray text-3xl md:text-5xl font-pixel text-center mb-4 h-16 motion-safe:animate-fade-in" data-countdown-target="countdown"></h3>
      <h3 class="text-deltarune-gray text-base font-pixel text-center mb-12 min-h-10 motion-safe:animate-fade-in" data-countdown-target="info"></h3>
    </div>
    <div class="border border-2 border-deltarune-gray aspect-video w-full flex items-center justify-center bg-black motion-safe:opacity-0 motion-safe:animate-fade-in transition-colors hover:border-white" style="animation-delay: 0.25s">
      <div class="relative block w-full bg-black aspect-video z-30" data-controller="video">
        <div class="relative aspect-video overflow-hidden w-full bg-black animate-fade" data-video-target="container">
          ...
          <img src="/assets/images/trailer-reveal-thumb.webp" class="absolute w-full h-full pointer-events-none z-30 bg-black text-transparent" data-scroll-target="parafade" alt="DELTARUNE trailer thumbnail" aria-hidden="true" />
        </div>
      </div>
    </div>
    
    <p class="w-full text-center px-4 my-2 font-pixel-regular text-xs text-deltarune-gray motion-safe:opacity-0 motion-safe:animate-fade-in transition-colors hover:border-white" style="animation-delay: 0.25s">By clicking to view this video, you agree to <a href="https://www.youtube.com/howyoutubeworks/our-commitments/protecting-user-data/" target="_blank" class="underline transition-opacity opacity-100 hover:opacity-90">YouTube's Privacy Policy</a></p>
    
  </section>

  <section id="game" class="container mx-auto max-w-2xl px-4 flex flex-col gap-4 text-center motion-safe:opacity-0 motion-safe:animate-fade-in transition-colors hover:border-white" style="animation-delay: 0.5s">
    <h4 class="text-white text-lg uppercase font-pixel">Coming To</h4>
    <div class="relative flex flex-row flex-wrap justify-center items-center max-w-md md:max-w-lg mx-auto gap-4">
      <a class="flex items-center justify-center border-2 border-white rounded-lg bg-white/10 p-3 w-28 h-20 md:w-32 md:h-24 transition-all duration-150 hover:bg-white/20 hover:duration-0 hover:border-deltarune-yellow" href="https://store.steampowered.com/app/1671210/DELTARUNE/" target="_blank">
        <img src="/assets/images/platform-square-steam-tall.png" alt="Steam" class="w-full h-full object-contain" />
      </a>
      <a class="flex items-center justify-center border-2 border-white rounded-lg bg-red-600/50 p-3 w-28 h-20 md:w-32 md:h-24 transition-all duration-150 hover:bg-red-600/70 hover:duration-0 hover:border-deltarune-yellow" href="https://www.nintendo.com/us/store/products/deltarune-switch-2/" target="_blank">
        <img src="/assets/images/platform-square-switch2.png" alt="Nintendo Switch 2" class="w-full h-full object-contain" />
      </a>
      <a class="flex items-center justify-center border-2 border-white rounded-lg bg-white/80 p-3 w-28 h-20 md:w-32 md:h-24 transition-all duration-150 hover:bg-white hover:duration-0 hover:border-deltarune-yellow" href="https://store.playstation.com/en-us/concept/233495" target="_blank">
        <img src="/assets/images/platform-square-ps5.png" alt="PlayStation 5" class="w-full h-full object-cover invert" />
      </a>
      <a class="flex items-center justify-center border-2 border-white rounded-lg bg-red-600/50 p-3 w-28 h-20 md:w-32 md:h-24 transition-all duration-150 hover:bg-red-600/70 hover:duration-0 hover:border-deltarune-yellow" href="https://www.nintendo.com/us/store/products/deltarune-switch/" target="_blank">
        <img src="/assets/images/platform-square-switch.png" alt="Nintendo Switch" class="w-full h-full object-contain" />
      </a>
      <a class="flex items-center justify-center border-2 border-white rounded-lg bg-blue-600/50 p-3 w-28 h-20 md:w-32 md:h-24 transition-all duration-150 hover:bg-blue-600/70 hover:duration-0 hover:border-deltarune-yellow" href="https://store.playstation.com/en-us/concept/233495" target="_blank">
        <img src="/assets/images/platform-square-ps4.png" alt="PlayStation 4" class="w-full h-full object-cover" />
      </a>
    </div>
    <h4 class="text-white text-lg uppercase font-pixel mb-4">Wishlist Now!</h4>
  </section>
  ...
  <section id="demo" class="relative w-full text-center mb-32 pt-8" data-controller="stars" data-scroll-target="parafade">
    ...
    <div class="relative container mx-auto max-w-2xl">
      <img class="lazyload w-full object-contain -z-20 inset-shadow-[0_10px_10px_rgba(0,0,0,1)]" src="/assets/images/bg.gif" alt="Castle Town" aria-hidden="true" />
      <div class="absolute bottom-0 flex flex-col gap-2 w-full mx-auto">
        <h2 class="text-transparent"><img src="/assets/images/logo.png" alt="DELTARUNE" class="w-xs md:w-md mx-auto" /></h2>
        <h3 class="text-xl text-white font-pixel mb-4"><span class="font-8bit">Demo (Chapter 1&2)</span><br/>Available Now</h3>
        <div class="relative flex gap-2 w-full justify-center">
          <img class="lazyload absolute w-full object-contain z-10 mt-[-5.5%]" src="/assets/images/ribbon.png" alt="Ribbon" aria-hidden="true" />
  ...
  <section id="about" data-scroll-target="parafade" data-controller="particles">
    <div class="relative flex justify-center">
      <div id="particles" class="absolute justify-center text-center w-full h-full overflow-hidden pointer-events-none z-10 hidden sm:flex motion-reduce:hidden" aria-hidden="true" data-particles-target="container"></div>
      <div id="particles_mobile" class="absolute justify-center text-center w-full h-full overflow-hidden pointer-events-none z-10 flex sm:hidden motion-reduce:hidden" aria-hidden="true" data-particles-target="mobile"></div>
      ...
      <h2 class="absolute top-[30%] md:top-[40%] mx-auto flex flex-col items-center justify-center gap-4 z-20"><span class="not-sr-only font-pixel text-2xl md:text-4xl highlight-white uppercase">About</span><img src="/assets/images/logo.png" alt="About DELTARUNE" class="w-xl px-12 md:px-0 highlight-white" /><span class="not-sr-only font-pixel text-2xl md:text-4xl highlight-white uppercase"> </span></h2>
      <img src="/assets/images/key-art.gif" alt="Silhouettes of Susie, Kris, and Ralsei standing in front of a fountain" class="w-4xl z-3" />
    ...
    <div class="relative bg-linear-to-b from-[#004FDE] to-[#001F7E]">
      <div class="container mx-auto max-w-2xl flex flex-col gap-6 px-4 py-8">
        <h3 class="highlight-yellow font-pixel text-lg md:text-2xl text-center">The next adventure in the UNDERTALE series has appeared!</h3>
  ...
  <section id="news" class="container mx-auto max-w-2xl text-center flex flex-col gap-4 px-4" data-scroll-target="parafade">
    <h4 class="text-white text-2xl uppercase font-pixel">News and Updates</h4>
